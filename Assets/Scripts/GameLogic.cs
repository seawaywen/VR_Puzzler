...
public class GameLogic : MonoBehaviour
{
	...
	private void displayStartPanel() {
		...
		controlSphereVisibility (true);
	}

	private void controlSphereVisibility(bool display){
		for (int i = 0; i < puzzleSpheres.Length; i++)
		{
			puzzleSpheres [i].SetActive (display);
		}
	}
